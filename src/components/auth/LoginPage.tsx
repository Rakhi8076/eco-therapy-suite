          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col items-end">
                  {!forgotMessage ? (
                    <Button
                      variant="link"
                      className="px-0 text-sm text-gold" // gold text
                      onClick={() => setForgotMessage('Check your email to reset your password.')}
                    >
                      Forgot password?
                    </Button>
                  ) : (
                    <p className="text-sm mt-2 text-right text-gold">
                      {forgotMessage}
                    </p>
                  )}
                </div>
              ...
              <Button
                ...
                size="lg"
                disabled={isLoading}
                className="w-full bg-gold text-white hover:bg-yellow-700"
                style={{ backgroundColor: '#CA8A04', color: '#fff' }} // force gold
                >
                {isLoading ? "Signing in..." : "Sign in"}
              </Button>
            </form>
            ...
            <div className="text-center">
              <p className="text-sm text-gold">
                Don't have an account?{' '}
                <Button variant="link" className="px-0 text-sm font-medium text-gold">
                  Sign up now
                </Button>
              </p>
            </div>
